...
<div class="row">
    <div class="col-lg-12 contenedorRecomendados">
        ...
        <div class="col-lg-12">    
            <h3 class="mt-3" style="text-align: center;">Indicas Feminizadas
            </h3>
            <hr>
        </div> 
        <div class="col-lg-12 padreProducto">   
        ...
        <div class="col-lg-12">    
            <h3 class="mt-3" style="text-align: center;">Indicas Automaticas
            </h3>
            <hr>
        </div> 
        <div class="col-lg-12 padreProducto">   
        ...
        <div class="col-lg-12">    
            <h3 class="mt-3" style="text-align: center;">Cbd Feminizadas
            </h3>
            <hr>
        </div> 
        <div class="col-lg-12 padreProducto">   
        ...
        <div class="col-lg-12">    
            <h3 class="mt-3" style="text-align: center;">Cbd Automaticas
            </h3>
            <hr>
        </div> 
        <div class="col-lg-12 padreProducto">   
